            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4 mb-4" style='font-family:Arial Rounded MT Bold'>Barang Masuk</h1>
                        <div class="card mb-4">
                            ...
                            <div class="col-xl-12 col-md-6" style="margin: 0 auto;">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body" style='font-size:25px; margin: 0 auto; font-weight:bold; font-family:Arial Rounded MT Bold'>Total Pembelian</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" style="margin:0 auto;" href="#"> 
                                        <?php
                                            $qry = mysqli_query($conn,"select sum((m.qty * s.hargasatuan)) as totalbrgmsk from masuk m, stock s where m.idbarang = s.idbarang");
                                            $jumstock = mysqli_fetch_array($qry);
                                            
                                            $totalstock = $jumstock['totalbrgmsk'];
                                            ...
                                            <tr>
                                             ...
                                             <div class="modal fade" id="edit<?=$idm;?>">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <br>
                                                                <input type="number" name="qty" min="0" value="<?=$qty;?>" class="form-control" required>
                                                                <br>
